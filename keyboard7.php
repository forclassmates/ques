<?
    $mysqli = new mysqli('localhost','m92105mv_quest','Quest123321','m92105mv_quest');
    ...
    $sql = "insert into users values(null,".chr(39).$_SESSION["name"].chr(39).",".$time.");";
    $res = $mysqli->query($sql);
    
    header('Location: http://m92105mv.beget.tech/end.html');
?>
<html lang="en">
<head>
    <meta charset="UTF-8">
   ...
   <script>
        ...
        const title = 'QUEST3'
        const url = 'kak_je_xochetsa_kanikuli/0Y/RgtC10LHRj9C70Y7QsdC70Y4=/lalop/menshechemtri/informatika/keyboard7.php'
...
<body>
    ...
    <h1 class="text-white" style="margin-top: 220px;">Пока всё</h1>
